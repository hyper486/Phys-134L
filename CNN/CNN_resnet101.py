...
# Initialize pre-trained ResNet-101 model
...
def main():
    ...
    # Freeze earlier layers and unfreeze the last few layers
    ct = 0
    for child in model.children():
        ct += 1
        if ct >= 7:  # Unfreeze from the 7th layer onwards, adjust as needed
    ...
    print("Model saved as 'resnet101_model.pth'")
